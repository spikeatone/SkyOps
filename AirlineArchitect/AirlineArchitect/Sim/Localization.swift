...
private let simLocalizationTables: [String: [String: String]] = [
    "de": [
        "%@ A checks completed": "%@ A-Checks abgeschlossen",
        "%@ back in service": "%@ wieder im Dienst",
        "%@ booked for %@": "%@ für %@ eingeplant",
        "%@ covering for %@": "%@ vertritt %@",
        "%@ grounded — %@ overdue": "%@ stillgelegt — %@ überfällig",
        "%@ in the shop ~%@ days at %@ · %@": "%@ ~%@ Tage in der Werkstatt (%@) · %@",
        "%@ decommissioned at %@": "%@ stillgelegt in %@",
        "%@ opened at %@": "%@ eröffnet in %@",
        "%@ overnight at your base, %@ in the shop for a day · %@": "%@ über Nacht an deiner Basis, %@ einen Tag in der Werkstatt · %@",
        "%@ upgraded to %@ at %@": "%@ auf %@ aufgerüstet in %@",
        "%@ scheduled": "%@ geplant",
        "%@ — %@ %@": "%@ — %@ %@",
        "%@ ↔\u{FE0E} %@ while %@ is in the shop": "%@ ↔\u{FE0E} %@, während %@ in der Werkstatt ist",
        "A new entrant": "Ein neuer Wettbewerber",
        "Contract MRO hangar slot in ~%@ days — it keeps flying until then · %@": "MRO-Hangarplatz in ~%@ Tagen — bis dahin fliegt es weiter · %@",
        "Contract MRO · one day each · %@": "Vertrags-MRO · je ein Tag · %@",
        "Maintenance here returns to the contract MRO.": "Die Wartung hier übernimmt wieder der Vertrags-MRO.",
        "Mandatory check · ~%@ days · %@": "Pflichtcheck · ~%@ Tage · %@",
        "Now handles heavy checks in-house · %@": "Erledigt schwere Checks jetzt im eigenen Haus · %@",
        "Researched and parked — open it from Network ▸ Routes when you're ready.": "Recherchiert und geparkt — öffne sie in Netzwerk ▸ Strecken, wenn du bereit bist.",
        "Returned from its check and reclaimed its route": "Aus dem Check zurück und hat seine Route wieder übernommen",
        "Route plan saved · %@": "Streckenplan gespeichert · %@",
        "Serviced overnight at your own base — no legs lost · %@": "Über Nacht an deiner eigenen Basis gewartet — kein Flug entfällt · %@",
        "Your own maintenance base — no MRO premium, no slot queue · %@": "Deine eigene Wartungsbasis — kein MRO-Aufschlag, keine Warteliste · %@",
        "contract MRO": "Vertrags-MRO",
        ...
        // Crew training pipeline (8 Sep 2026)
        "Crew hired": "Crew eingestellt",
        "%@: rated crew hired · line-ready in %@ days": "%@: typengeprüfte Crew eingestellt · einsatzbereit in %@ Tagen",
        "%@: new hire in the type-rating course with %@ · line-ready in %@ days": "%@: Neueinstellung im Type-Rating-Kurs bei %@ · einsatzbereit in %@ Tagen",
        "Crew requalification": "Crew-Requalifizierung",
        "%@: %@ lapsed crew back in training with %@ · ~%@ days": "%@: %@ Crew mit abgelaufener Lizenz wieder im Training bei %@ · ~%@ Tage",
        "Recurrent training": "Wiederkehrendes Training",
        "%@: %@ crew in recurrent with %@ · back in ~%@ days": "%@: %@ Crew im wiederkehrenden Training bei %@ · zurück in ~%@ Tagen",
        // Training Center (Phase 2)
        "Training center opened": "Trainingszentrum eröffnet",
        "Your own training center is open at %@ — add a sim bay per crew family to train in-house": "Dein eigenes Trainingszentrum in %@ ist eröffnet – füge pro Crew-Familie einen Simulatorplatz hinzu, um intern zu schulen",
        "Sim bay added": "Simulatorplatz hinzugefügt",
        "%@ crews now train in-house at %@ — courses cheaper and shorter, no waiting for a class slot": "%@-Crews trainieren jetzt intern in %@ – Kurse günstiger und kürzer, kein Warten auf einen Kursplatz",
        "%@: new hire in the type-rating course in-house · line-ready in %@ days": "%@: Neueinstellung im internen Type-Rating-Kurs · einsatzbereit in %@ Tagen",
        "%@: %@ lapsed crew back in training in-house · ~%@ days": "%@: %@ Crew mit abgelaufener Lizenz wieder im internen Training · ~%@ Tage",
        "%@: %@ crew in recurrent in-house · back in ~%@ days": "%@: %@ Crew im internen wiederkehrenden Training · zurück in ~%@ Tagen",
