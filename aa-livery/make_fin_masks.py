...
#      trace_fin.py DH8B  --x0 0.640 --x1 0.906 --stab-top 0.072 --base 0.585
#      trace_fin.py AT46  --x0 0.650 --x1 0.872 --stab-top 0.085 --base 0.560
#      trace_fin.py B1900 --x0 0.700 --x1 0.880 --stab-top 0.135 --base 0.545
#      trace_fin.py D328  --x0 0.650 --x1 0.876 --stab-top 0.080 --base 0.575
#
